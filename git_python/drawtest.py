...
data = map_matrix.reshape(max_X, max_Y)
fig = plt.imshow(data, cmap = colormap, norm = perso_norm)
...
#map_plot, = plt.plot(np.arange(0,n,1), np.linspace(max_value, max_value, n),lw=1, color='red')
