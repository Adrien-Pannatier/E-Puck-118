...
static THD_FUNCTION(CaptureImage, arg) {
	...
	po8030_advanced_config(FORMAT_RGB565, 0, HEIGHT_PIXEL_LINE, IMAGE_BUFFER_SIZE, NB_LINE, SUBSAMPLING_X1, SUBSAMPLING_X1);
...
static THD_WORKING_AREA(waProcessImage, 14000);
...
//					green_value  = (img_buff_ptr[2*i+1] & MASK_GREEN_L)>>5 | (img_buff_ptr[2*i + j*(2*IMAGE_BUFFER_SIZE)] & MASK_GREEN_H)>>3;
//
